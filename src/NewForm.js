...
const NewForm=({closehandlerNF,refreshhandler})=>{
    ...
    const [newdata,setnewdata]=useState({name:"",price:undefined,mrp:undefined,discount:undefined,description:"",size:"",quantity:undefined,color:"",occassion:"",url:""})
   ...
   return(
       <div className="form">
           <div className="innerform">
              ...
              <input placeholder="Price" name="price" value={newdata.price} onChange={(e)=>{setnewdata({...newdata,[e.target.name]:e.target.value})}}></input>
              <input placeholder="MRP" name="mrp" value={newdata.mrp} onChange={(e)=>{setnewdata({...newdata,[e.target.name]:e.target.value})}}></input>
              <input placeholder="Discount" name="discount" value={newdata.discount} onChange={(e)=>{setnewdata({...newdata,[e.target.name]:e.target.value})}}></input>
              ...
              <input placeholder="Quantity" name="quantity" value={newdata.quantity} onChange={(e)=>{setnewdata({...newdata,[e.target.name]:e.target.value})}}></input>
